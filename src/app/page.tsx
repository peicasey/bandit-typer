...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center gap-16 bg-lightGreen">
      <div className="flex items-center justify-between gap-16 p-16 pb-[30vw] bg-white wave-container">
        <div>
          <Image
            src="/bandit.png"
            alt=""
        ...
        <div className="flex flex-col gap-8">
          <h1 className="text-firGreen text-6xl font-bold" style={poppins.style}>BanditTyper</h1>
          <p>
      ...
      <div className="bg-[#7ea77d] w-full p-8 flex gap-8">
        ...
        <div>
          <p>Check our our promotional Youtube video!</p>
        </div>
      </div>
